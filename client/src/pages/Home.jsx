    ...
    <Content className='bg-slate-200 dark:bg-Dark-Desaturated-Blue'>
      ...
      <div className='mx-6 my-4'>
        <div className='flex flex-wrap gap-4 justify-center mb-4'>
          <Card title={'Estudiantes Egresados'} quantity={totalEgresados}></Card>
          <Card title={'Estudiantes Regulares'} quantity={totalRegulares}></Card>
          <Card title={'Estudiantes Nuevo Ingreso'} quantity={totalNuevoIngreso}></Card>
          <Card title={'Estudiantes Reincorporados'} quantity={totalReincorporados}></Card>
          <Card title={'Estudiantes No Inscritos'} quantity={totalNoInscritos}></Card>
          <Card title={'Estudiantes Extension'} quantity={totalExtension}></Card>
        </div>
        <div className='flex flex-wrap gap-5 justify-center'>
          <div className='bg-white shadow-md rounded-md w-[47%] p-4'>
            <h1 className='text-center text-xl mb-4 font-medium text-slate-700'>Estudiantes por Carrera</h1>
            <div id="chartCarreras" style={{ width: "100%", height: "300px" }}></div>
          </div>
          <div className='bg-white shadow-md rounded-md w-[47%] p-4'>
            <h1 className='text-center text-xl mb-4 font-medium text-slate-700'>Estudiantes por Turno</h1>
            <div className='my-5' id="chartTurnos" style={{ width: "100%", height: "300px" }}></div>
          </div>
          <div className='bg-white shadow-md rounded-md w-[47%] p-4'>
            <h1 className='text-center text-xl mb-4 font-medium text-slate-700'>Estudiantes por Lapso</h1>
            <div className='my-5' id="chartLapsos" style={{ width: "100%", height: "300px" }}></div>
          </div>
          <div className='bg-white shadow-md rounded-md w-[47%] p-4'>
            <h1 className='text-center text-xl mb-4 font-medium text-slate-700'>Estudiantes por Genero</h1>
            <div className='my-5' id="chartGeneros" style={{ width: "100%", height: "300px" }}></div>
          </div>
        </div>
      </div>
    </Content>
