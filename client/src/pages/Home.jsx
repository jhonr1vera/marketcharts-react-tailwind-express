...
export default function Home() {
  ...
  const handleReportDownload = async () => {
    ...
    try {
      ...
      doc.setFontSize(12);
      doc.text(20, 45, 'En este informe, se presentan los resultados del análisis de datos realizado sobre los estu-');
      doc.text(20, 55, 'diantes del ISUM. El objetivo principal es proporcionar una visión clara y entendible de los ');
      doc.text(20, 65, 'datos a través de gráficos y visualizaciones que faciliten la interpretación de la información.');
      doc.text("Para llevar a cabo este análisis, se utilizaron diversas técnicas de procesamiento y visuali-", 20, 80);
      doc.text("zación de datos. Los datos fueron recopilados de Control de estudios y se procesaron utili-", 20, 90);
      doc.text("zando el sistema MarketCharts. A continuación, se presentan los gráficos más relevantes", 20, 100);
      doc.text("que ilustran los hallazgos clave del análisis.", 20, 110);
      
      // First Chart
      doc.text("1.", 20, 120);
      doc.addImage(imgStudentsType, 'PNG', 20, 125, 165, 85);
      doc.text("El primer grafico muestra la cantidad de estudiantes según el tipo de estudiante, lo que", 20, 220);
      doc.text("deja en evidencia que:", 20, 230);
      doc.text(`Del 100% de los estudiantes, que representa en enteros: ${studentTypeSum}, se clasifican en:`, 20, 240);
      doc.text(`${((totalNoInscritos / studentTypeSum) * 100).toFixed(2)}% son No Inscritos (${totalNoInscritos} en enteros)`, 20, 250);
      doc.text(`${ ((totalRegulares / studentTypeSum) * 100).toFixed(2)}% son Regulares (${totalRegulares} en enteros)`, 20, 260);
      doc.text(`${ ((totalEgresados / studentTypeSum) * 100).toFixed(2)}% son Egresados (${totalEgresados} en enteros)`, 20, 270);
      doc.text(`${ ((totalNuevoIngreso / studentTypeSum) * 100).toFixed(2)}% son Nuevo Ingreso (${totalNuevoIngreso} en enteros)`, 20, 280);
    ...
    doc.text("El segundo grafico muestra la cantidad de estudiantes ACTIVOS según la carrera que ", 20, 150);
    doc.text("estudian, lo que deja en evidencia que:", 20, 160);
    doc.text(`Del 100% de los estudiantes activos, que representan en enteros: ${activeStudents}, se clasifican en:`, 20, 170);
    doc.text(`${((informaticaData.count / activeStudents) * 100).toFixed(2)}% son Informática (${informaticaData.count} en enteros)`, 20, 180)
    doc.text(`${((gestionFiscalData.count / activeStudents) * 100).toFixed(2)}% son Gestión Fiscal y Tributaria (${gestionFiscalData.count} en enteros)`, 20, 190);
    doc.text(`${((administracionData.count / activeStudents) * 100).toFixed(2)}% son Administración (${administracionData.count} en enteros)`, 20, 200);
    doc.text(`${((mercadeoData.count / activeStudents) * 100).toFixed(2)}% son Mercadeo (${mercadeoData.count} en enteros)`, 20, 210);

    doc.addPage();
    // Third Chart
    doc.text(20, 30, '3.');
    doc.addImage(imgStudentDayShift, 'PNG', 20, 40, 165, 80);
    doc.text("El segundo grafico muestra la cantidad de estudiantes ACTIVOS según el turno en el", 20, 140);
    doc.text("que estudian, lo que deja en evidencia que:", 20, 150);
    doc.text(`Del 100% de los estudiantes activos, que representan en enteros: ${activeStudents}, se clasifican en:`, 20, 160);
    doc.text(`${((diurnoData.count / activeStudents) * 100).toFixed(2)}% son Diurno (${diurnoData.count} en enteros)`, 20, 170);
    doc.text(`${((nocturnoData.count / activeStudents) * 100).toFixed(2)}% son Nocturno (${nocturnoData.count} en enteros)`, 20, 180);

    doc.addPage();
    // Fourth Chart
    doc.text(20, 30, '4.');
    doc.addImage(imgStudentGender, 'PNG', 20, 40, 165, 80);
    doc.text("El cuarto grafico muestra la cantidad de estudiantes ACTIVOS según su genero, lo que ", 20, 140);
    doc.text("deja en evidencia que:", 20, 150);
    doc.text(`Del 100% de los estudiantes activos, que representan en enteros: ${activeStudents}, se clasifican en:`, 20, 160);
    doc.text(`${((masculinoData.count / activeStudents) * 100).toFixed(2)}% son Masculino (${masculinoData.count} en enteros)`, 20, 170);
    doc.text(`${((femeninoData.count / activeStudents) * 100).toFixed(2)}% son Femenino (${femeninoData.count} en enteros)`, 20, 180);

    doc.addPage();
    // Fifth Chart
    doc.text(20, 30, '5.');
    doc.addImage(imgStudentPeriod, 'PNG', 20, 40, 165, 80);
    doc.text("El cuarto grafico muestra la cantidad de estudiantes REGULARES según el periodo que ", 20, 140);
  ...
  // activeStudents
  const activeStudents = totalReincorporados + totalNuevoIngreso + totalRegulares;
        ...
        <Content className="bg-slate-200 dark:bg-Dark-Desaturated-Blue">
          <div className="mt-20 px-6 inline-flex items-center justify-between w-[100%]">
            ...
            <div className="inline-flex gap-4">
              <button className="text-lg text-white bg-blue-500 rounded-md px-2 py-[0.6rem] flex hover:bg-blue-600 items-center gap-1" id="reportImage">
          ...
          <div className="mx-6 my-4 bg-slate-200" id="printReport">
            ...
            <div className="flex justify-center items-center">
              ...
              <InfoCard style={"translate-y-[-50%]"} text={"Instituto Universitario de Mercadotecnia"}></InfoCard>
            </div>
            ...
            <div className="flex flex-wrap gap-5 justify-center ">
              <div className="bg-white shadow-md rounded-md w-[47%] p-4">
                <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes según su tipo, excluyendo a Extension Universitaria"}></InfoCard>
                </div>
                <div
              ...
              <div className="bg-white shadow-md rounded-md w-[47%] p-4">
                <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes activos según su carrera"}></InfoCard>
                </div>
                <div
                  id="chartCarreras"
                  style={{ width: "100%", height: "500px" }}
              ...
              <div className="bg-white shadow-md rounded-md w-[47%] p-4">
                <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes activos según su turno de estudio"}></InfoCard>
                </div>
                <div
                  className="my-5"
                  id="chartTurnos"
              ...
              <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes activos según su período"}></InfoCard>
                </div>
                <div
                  className="my-5"
                  id="chartLapsos"
              ...
              <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes activos según su género"}></InfoCard>
                </div>
                <div
                  className="my-5"
                  id="chartGeneros"
              ...
              <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes nuevo ingreso según su motivo de ingreso"}></InfoCard>
                </div>
                <div
                  className="my-5"
                  id="chartMotivos"
              ...
              <div className="flex justify-center items-center">
                <h1 className="text-center text-xl mb-4 font-medium text-slate-700">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Este gráfico muestra el crecimiento o decrecimiento de numero de egresados desde la fundacion de la institución"}></InfoCard>
                </div>
              ...
              <InfoCard style={"translate-y-[-50%]"} text={"Extensión Universitaria"}></InfoCard>
              </div>
              ...
              <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes de extensión según el diplomado que cursan"}></InfoCard>
                </div>
                <div
              ...
              <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes de extensión según su género"}></InfoCard>
                </div>
                <div
                  className="my-5"
                  id="chartGenerosExt"
              ...
              <div className="flex justify-center items-center">
                  ...
                  <InfoCard style="ml-3 mb-3" text={"Esta gráfica muestra el porcentaje de estudiantes de extension según su motivo de ingreso"}></InfoCard>
                </div>
                <div
                  className="my-5"
                  id="chartMotivosExt"
