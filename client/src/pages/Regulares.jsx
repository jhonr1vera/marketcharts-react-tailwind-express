            ...
            <Content className=' bg-slate-200 h-screen '>
                <div className='my-3 mx-4'>
                    ...
                    <div className='justify-between flex mb-10 mx-[1.3rem]'>
                        <div className='grid'>
                            <h1 className='text-2xl tracking-wide text-slate-700 mt-5'>Estudiantes Regulares</h1>
                            <h3 className='text-lg mt-2 text-slate-700'>{totalRegulares} en total</h3>
                        </div>
                    </div>

                    <div className=''>
                        <table className="min-w-full divide-y divide-gray-200 mt-10" id="myTable">
